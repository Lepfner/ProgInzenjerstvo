...
const Recovery = () => {
  ...
  return (
    <div className=" flex flex-col justify-center pl-8 pb-12 lg:w-5/6 md:w-full max-sm:pl-0 pb-8 w-full">
      <h1 className="lg:text-6xl mb-2 md: text-5xl sm: text-4xl">RECOVERY:</h1>
      <div className="w-full flex flex-col lg:text-lg md:flex-row text-base sm:flex-col ">
        ...
        <div
          className=" border-solid border-2 pl-4 mt-4 border-l-orange-500 
                         lg:h-40 md:w-2/5 pl-8 max-sm:h-auto"
        >
          <p className="text mb-4 font-bold">Write your e-mail so we can
            send you your information.</p>
        </div>
      </div>
    </div>
  )
