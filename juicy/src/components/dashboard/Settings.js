    ...
    <>
      ...
      <div className=' w-full flex justify-center items-center mt-10'>
        <div className='bg-skin-primary w-3/4 p-3 rounded-2xl text-center flex items-center space-x-4 shadow-xl flex-col sm:flex-row'>
          <div className='w-5/12 flex flex-col justify-center items-baseline border-r text-white'>
            <div className='mt-8'>
            ...
            <h1 className="bg-skin-primary text-3xl mt-10 mb-4">REPORT:</h1>
            <textarea
            ...
            <button
              className="block bg-gray-700 px-4 w-32 rounded-md p-2 mt-4 text-white hover:bg-orange-600 lg:text-xl md:text-lg sm: text-lg flex justify-center">
                Send
            </button>
          ...
          <div className='m-10 w-2/3 flex flex-col justify-center bg-skin-primary text-white text-center'>
